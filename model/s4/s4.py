...
class S4(nn.Module):
    def __init__(
        ...
        mode='nplr' is the full S4 model; 'diag' is the simpler S4D; 'slow' is a dense version for testing
        ...
        # SSM Kernel
        self.kernel = SSKernel(self.H, N=self.N, L=self.L, channels=channels, mode=mode, verbose=verbose, **kernel_args)
    ...
    def forward(self, u, state=None, rate=1.0, lengths=None, return_state=True, **kwargs):
        """
